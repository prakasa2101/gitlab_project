...
project_name    = "opt-ct"
project_owner   = "sjohn@optmedtech.com"
...
tags = {
  "environment"   = "dev"
  "project:owner" = "sjohn@optmedtech.com"
  "project:name"  = "opt-ct"
  "git:repo"      = "opt-med-tech/iac/iac-code"
...
kms_keys = {
  ...
  "sns-topics" = {
    description = "sns topics encryption Key"
    services    = ["sns.amazonaws.com"]
    alias       = "snstopics"
  }
}
